...
<!--TODO:  d_id 값을 통해 데이터를 불러온 후, 수정하든 삭제하든 할 것.   '카테고리'를 싸그리 정리하는 방법도... 2018.03.27-->
<!--    <form method="POST" action="/index.php/Transaction/manage/edit" id="insertion_form" class="form-horizontal">-->
<!---->
<!--        <!---->
